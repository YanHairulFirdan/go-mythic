...
<template>
    ...
    <PrototypeLayout>
        <section class="flex items-center gap-3 pb-5 pt-4">
            ...
            <h1 class="text-xl font-bold tracking-tight">Tambah customer</h1>
        </section>
        ...
        <form class="space-y-4 pb-8" @submit.prevent="submit">
            <div>
                ...
                <input id="name" v-model="form.name" type="text" required placeholder="Nama customer" class="block w-full rounded-xl border-slate-200 bg-white px-3 py-3 text-sm font-semibold text-slate-700 placeholder:text-slate-300 focus:border-primary-500 focus:ring-primary-500" />
            ...
            <div>
                ...
                <input id="contact" v-model="form.contact" type="text" placeholder="0812-3456-7890" class="block w-full rounded-xl border-slate-200 bg-white px-3 py-3 text-sm font-semibold text-slate-700 placeholder:text-slate-300 focus:border-primary-500 focus:ring-primary-500" />
            ...
            <div>
                ...
                <textarea id="address" v-model="form.address" rows="3" placeholder="Jl. contoh No.1, Denpasar" class="block w-full resize-none rounded-xl border-slate-200 bg-white px-3 py-3 text-sm text-slate-700 placeholder:text-slate-300 focus:border-primary-500 focus:ring-primary-500" />
