        ...
        <form class="space-y-4 pb-8" @submit.prevent="submit">
            ...
            <div v-if="isIncome">
                ...
                <p v-if="selectedInvoice" class="mt-1 text-[11px] text-slate-500">
                    Customer transaksi otomatis mengikuti invoice. Sisa saldo {{ rupiah(selectedInvoice.remaining) }}.
                </p>
            ...
            <div>
                <label for="attachment" class="mb-1.5 block text-[10px] font-extrabold uppercase tracking-wider text-slate-400">
                    Lampiran <span class="font-medium normal-case tracking-normal text-slate-400">(opsional · JPG/PNG/WEBP, maks 1 MB)</span>
                </label>
                <input
                    id="attachment"
                    type="file"
